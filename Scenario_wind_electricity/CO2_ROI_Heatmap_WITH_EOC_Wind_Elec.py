...
climate_ROI_formic_acid_Catalytic_reduction_of_CO2_with_H2_array_WITH_EOC\
                                        ...
                                        CO2_ROI_Constants_Wind_Elec.formic_acid,\
                                        CO2_ROI_Constants_Wind_Elec.Catalytic_reduction_of_CO2_with_H2,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_formic_acid_conventional_mean, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_formic_acid_conventional_sd,\
                                        CO2_ROI_Constants_Wind_Elec.lognormal_distribution)
...
climate_ROI_formic_acid_Electrolytic_reduction_of_CO2_with_H2_array_WITH_EOC\
                                        =f_get_climate_ROI_for_chemical_list(\
                                        CO2_ROI_Constants_Wind_Elec.formic_acid,\
                                        CO2_ROI_Constants_Wind_Elec.Electrolytic_reduction_of_CO2,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_formic_acid_conventional_mean, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_formic_acid_conventional_sd,\
                                        CO2_ROI_Constants_Wind_Elec.lognormal_distribution)
...
climate_ROI_polyol_NA_array_WITH_EOC\
                                        =f_get_climate_ROI_for_chemical_list(\
                                        CO2_ROI_Constants_Wind_Elec.polyol,\
                                        CO2_ROI_Constants_Wind_Elec.NA,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_polyol_conventional_mean, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_polyol_conventional_sd,\
                                        CO2_ROI_Constants_Wind_Elec.lognormal_distribution)
...
climate_ROI_methane_Hydrogenation_of_CO2_array_WITH_EOC\
                                        =f_get_climate_ROI_for_chemical_list(\
                                        CO2_ROI_Constants_Wind_Elec.Methane,\
                                        CO2_ROI_Constants_Wind_Elec.Hydrogenation_of_CO2,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_methane_conventional_mean, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_methane_conventional_sd,\
                                        CO2_ROI_Constants_Wind_Elec.lognormal_distribution)
...
climate_ROI_DMC_Electrochemical_reduction_of_CO2_with_MeOH_array_WITH_EOC\
                                        =f_get_climate_ROI_for_chemical_list(\
                                        CO2_ROI_Constants_Wind_Elec.DMC,\
                                        CO2_ROI_Constants_Wind_Elec.Electrochemical_reduction_of_CO2_with_MeOH,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_DMC_conventional_LB, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_DMC_conventional_UB,\
                                        CO2_ROI_Constants_Wind_Elec.uniform_distribution)
...
climate_ROI_DMC_Ethylene_carbonate_transesterification_array_WITH_EOC\
                                        =f_get_climate_ROI_for_chemical_list(\
                                        CO2_ROI_Constants_Wind_Elec.DMC,\
                                        CO2_ROI_Constants_Wind_Elec.Ethylene_carbonate_transesterification,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_DMC_conventional_LB, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_DMC_conventional_UB,\
                                        CO2_ROI_Constants_Wind_Elec.uniform_distribution)
...
climate_ROI_DMC_Urea_transesterification_array_WITH_EOC\
                                        =f_get_climate_ROI_for_chemical_list(\
                                        CO2_ROI_Constants_Wind_Elec.DMC,\
                                        CO2_ROI_Constants_Wind_Elec.Urea_transesterification,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_DMC_conventional_LB, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_DMC_conventional_UB,\
                                        CO2_ROI_Constants_Wind_Elec.uniform_distribution)
...
climate_ROI_CO_Dry_Reforming_array_WITH_EOC\
                                        =f_get_climate_ROI_for_chemical_list(\
                                        CO2_ROI_Constants_Wind_Elec.CO,\
                                        CO2_ROI_Constants_Wind_Elec.Dry_Reforming,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_CO_conventional_mean, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_CO_conventional_sd,\
                                        CO2_ROI_Constants_Wind_Elec.lognormal_distribution)
...
climate_ROI_CO_reverseWater_Gas_Shift_array_WITH_EOC\
                                        =f_get_climate_ROI_for_chemical_list(\
                                        CO2_ROI_Constants_Wind_Elec.CO,\
                                        CO2_ROI_Constants_Wind_Elec.reverseWater_Gas_Shift,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_CO_conventional_mean, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_CO_conventional_sd,\
                                        CO2_ROI_Constants_Wind_Elec.lognormal_distribution)
...
climate_ROI_DME_NA_array_WITH_EOC\
                                        =f_get_climate_ROI_for_chemical_list(\
                                        CO2_ROI_Constants_Wind_Elec.DME,\
                                        CO2_ROI_Constants_Wind_Elec.NA,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_DME_conventional_mean, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_DME_conventional_sd,\
                                        CO2_ROI_Constants_Wind_Elec.lognormal_distribution)
                                        
climate_ROI_kerosene_NA_array_WITHOUT_EOC,\
climate_ROI_kerosene_NA_array_WITH_EOC\
                                        =f_get_climate_ROI_for_chemical_list(\
                                        CO2_ROI_Constants_Wind_Elec.Kerosene,\
                                        CO2_ROI_Constants_Wind_Elec.NA,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_kerosene_conventional_mean, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_kerosene_conventional_sd,\
                                        CO2_ROI_Constants_Wind_Elec.lognormal_distribution)

climate_ROI_MeOH_Hydrogenation_of_CO2_array_WITHOUT_EOC, \
climate_ROI_MeOH_Hydrogenation_of_CO2_array_WITH_EOC\
                                        =f_get_climate_ROI_for_chemical_list(\
                                        CO2_ROI_Constants_Wind_Elec.MeOH,\
                                        CO2_ROI_Constants_Wind_Elec.Hydrogenation_of_CO2,\
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_MeOH_conventional_mean, \
                                        CO2_ROI_Constants_Wind_Elec.CO2_emissions_MeOH_conventional_sd,\
                                        CO2_ROI_Constants_Wind_Elec.lognormal_distribution)
...
Climate_ROI_Concrete_Curing_OPC_only_array, percentage_change_comp_strength_Concrete_Curing_OPC_only_array\
                                       ...
                                       CO2_ROI_Constants_Wind_Elec.excel_sheet_name_concrete,\
                                       CO2_ROI_Constants_Wind_Elec.dataset_category_Curing_OPC_only,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_first_input_parameter, \
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_last_input_parameter,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_Compressive_strength_range_LB,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_Compressive_strength_range_UB,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_CO2_Utilized_Duplicate,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_CO2_Utilized,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_CCU_first_input_parameter,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_CCU_last_input_parameter,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_CCU_Compressive_strength_range_LB,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_CCU_Compressive_strength_range_UB,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_CCU_CO2_Utilized_Duplicate,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_CCU_concrete_CO2_utilized)

Climate_ROI_Concrete_Curing_OPC_plus_SCM_array,percentage_change_comp_strength_Concrete_Curing_OPC_plus_SCM_array\
                                       =f_get_climate_ROI_for_concrete_list(\
                                       CO2_ROI_Constants_Wind_Elec.excel_sheet_name_concrete,\
                                       CO2_ROI_Constants_Wind_Elec.dataset_category_Curing_OPC_plus_SCM,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_first_input_parameter, \
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_last_input_parameter,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_Compressive_strength_range_LB,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_Compressive_strength_range_UB,\
...
Climate_ROI_Concrete_Mixing_OPC_only_array,percentage_change_comp_strength_Concrete_Mixing_OPC_only_array\
                                       =f_get_climate_ROI_for_concrete_list(\
                                       CO2_ROI_Constants_Wind_Elec.excel_sheet_name_concrete,\
                                       CO2_ROI_Constants_Wind_Elec.dataset_category_Mixing_OPC_only,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_first_input_parameter, \
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_last_input_parameter,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_Compressive_strength_range_LB,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_Compressive_strength_range_UB,\
...
Climate_ROI_Concrete_Mixing_OPC_plus_SCM_array, percentage_change_comp_strength_Concrete_Mixing_OPC_plus_SCM_array\
                                       =f_get_climate_ROI_for_concrete_list(\
                                       CO2_ROI_Constants_Wind_Elec.excel_sheet_name_concrete,\
                                       CO2_ROI_Constants_Wind_Elec.dataset_category_Mixing_OPC_plus_SCM,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_first_input_parameter, \
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_last_input_parameter,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_Compressive_strength_range_LB,\
                                       CO2_ROI_Constants_Wind_Elec.column_name_conventional_Compressive_strength_range_UB,\
...
heatmap_fig.savefig('heatmap_WITH_EOC_Wind_Elec.png')
