...
This python file contains constants which are required by the following files in the 'Scenario_wind_electricity' folder
1. CO2_ROI_Heatmap_WITH_EOC.py
2. CO2_ROI_Functions.py
...
#number_of_products_WITHOUT_EOC=17
...
#number_of_samples_per_datasets_concrete_CO2_curing_OPC_only=1000
#number_of_samples=number_of_datasets_concrete_CO2_curing_OPC_only*\
#                  number_of_samples_per_datasets_concrete_CO2_curing_OPC_only
...
#MeOH_without_H2_plot_color='dimgray'
#MeOH_with_H2_plot_color='magenta'
#MeOH_with_env_opp_cost_plot_color='brown'
...
US_elec_CO2_intensity_LB=0.0279
US_elec_CO2_intensity_UB=0.0279
...
#CO2_emissions_heat_per_kWh_mean=0.01
#CO2_emissions_heat_per_kWh_sd=0
#
#CO2_emissions_heat_per_MJ_mean=0.01
#CO2_emissions_heat_per_MJ_sd=0
#
#CO2_emissions_natural_gas_per_kg_mean=0.01
#CO2_emissions_natural_gas_per_kg_sd=0
#
#CO2_emissions_natural_gas_per_m3_mean=0.01
#CO2_emissions_natural_gas_per_m3_sd=0.0
#
#CO2_emissions_steam_per_kg_mean=0.01
#CO2_emissions_steam_per_kg_sd=0.0
#
#CO2_emissions_steam_per_MJ_mean=0.01
#CO2_emissions_steam_per_MJ_sd=0.0
...
CO2_emissions_electricity_LB=0.0279
CO2_emissions_electricity_UB=0.0279
...
#CO2_emissions_methane_mean=0.208
#CO2_emissions_methane_sd=0.028
...
CCU_CO2_Curing_Elec_CO2_intensity_LB = 0.0279
CCU_CO2_Curing_Elec_CO2_intensity_UB = 0.0279
...
CCU_Injection_Elec_CO2_Intensity_LB = 0.0279
CCU_Injection_Elec_CO2_Intensity_UB = 0.0279

#CCU_Vaporization_Elec_CO2_Intensity_LB = 0.386
#CCU_Vaporization_Elec_CO2_Intensity_UB = 0.568

CCU_Vaporization_Elec_CO2_Intensity_LB = 0.0279
CCU_Vaporization_Elec_CO2_Intensity_UB = 0.0279
...
mineralization_electricity_CO2_Intensity_LB = 0.0279
mineralization_electricity_CO2_Intensity_UB = 0.0279
