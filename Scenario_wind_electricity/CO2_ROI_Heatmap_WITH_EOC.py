...
climate ROI of alternate CCU pathways when wind electricity is used to produce CCU concrete, chemicals and minerals. 
The heatmap accounts for the environemtnal opportunity cost. 
The heatmap is presented in Supplementary Figure 2 in the Supplementary Information file.
