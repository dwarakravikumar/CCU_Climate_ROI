...
climate ROI of alternate CCU pathways. The heatmap does not account for the environemtnal opportunity cost. 
The heatmap is presented in Figure 4(b) in the main manuscript.
...
super_array.append(climate_ROI_formic_acid_Catalytic_reduction_of_CO2_with_H2_array_WITHOUT_EOC.flatten()) 
super_array.append(climate_ROI_CO_Dry_Reforming_array_WITHOUT_EOC.flatten())
super_array.append(climate_ROI_CO_reverseWater_Gas_Shift_array_WITHOUT_EOC.flatten()) 
super_array.append(climate_ROI_MeOH_Hydrogenation_of_CO2_array_WITHOUT_EOC.flatten())
super_array.append(climate_ROI_methane_Hydrogenation_of_CO2_array_WITHOUT_EOC.flatten())
...
super_array.append(climate_ROI_formic_acid_Electrolytic_reduction_of_CO2_with_H2_array_WITHOUT_EOC.flatten())  
...
super_array.append(climate_ROI_DMC_Electrochemical_reduction_of_CO2_with_MeOH_array_WITHOUT_EOC.flatten()) 
super_array.append(Climate_ROI_Mineralization_With_Compressive_Strength_array.flatten())
super_array.append(climate_ROI_MeOH_Electrolytic_reduction_of_CO2_array_WITHOUT_EOC.flatten()) 
...
heatmap_fig.savefig('heatmap_WITHOUT_EOC.png')
